...
defaults to the area-weighted method. The code chunks here are **not
executed** (they need the reanalysis archive); the one exception is
reading the bundled lake polygon.
