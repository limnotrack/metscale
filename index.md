...
| Read daily CMIP6 / CCAM projections at a point (model-calendar aware) for the delta-change step | [`extract_climate_point()`](http://limnotrack.com/metscale/reference/extract_climate_point.md) |
